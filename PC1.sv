...
module PC1(	// <stdin>:3:3
  input         clock,	// <stdin>:4:11
                reset,	// <stdin>:5:11
  output [31:0] io_pc	// src/main/scala/pc/PC1.scala:12:22
);

  reg [31:0] pc;	// src/main/scala/pc/PC1.scala:15:27
  always @(posedge clock) begin	// <stdin>:4:11
    if (reset)	// <stdin>:4:11
      pc <= 32'h0;	// src/main/scala/pc/PC1.scala:15:27
    else	// <stdin>:4:11
      pc <= pc + 32'h4;	// src/main/scala/pc/PC1.scala:15:27, :22:17
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// <stdin>:3:3
    ...
    initial begin	// <stdin>:3:3
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3:3
        ...
        pc = _RANDOM[/*Zero width*/ 1'b0];	// <stdin>:3:3, src/main/scala/pc/PC1.scala:15:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_pc = pc;	// <stdin>:3:3, src/main/scala/pc/PC1.scala:15:27
endmodule
